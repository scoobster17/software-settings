...
# TODO: check shell and have read -p for bash
read "?Opened Mac App Store, please manually log in and then hit any key here to continue installation/setup. If you don't do this, 'mas' apps like trello won't be installed. (Press any key)"
